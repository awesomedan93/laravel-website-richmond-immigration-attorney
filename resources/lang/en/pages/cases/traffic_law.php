...
return [
    'title' => 'Traffic Law',
    'sub_title' => 'Richmond Traffic Lawyer',
    'page_content' => '<h6 class="bold_text">DON’T RISK LOSING YOUR LICENSE</h6>
            <p>Traffic violations in Virginia can be serious offenses. Most drivers never think about fighting their traffic tickets or moving violations in Virginia. With the help of a qualified and experienced traffic lawyer, you could have your charges reduced or even dismissed. If you have gotten a ticket in Richmond, Henrico, Chesterfield or surrounding areas in Virginia, contact our law office today for a free consultation.</p>
            <h6 class="bold_text">HOW MANY POINTS WILL I GET ON MY LICENSE FOR A TRAFFIC TICKET IN VIRGINIA?</h6>
            <p>Virginia uses a system of demerit points for moving traffic violations. The number of points on your license varies according to the nature of the violation. Less serious violations typically result in three demerit points while more serious violations such as DUI or reckless driving can result in up to six demerit points. In addition to possible suspension of license, demerit points can carry other negative implications such as an increase in your car insurance.</p>
            ...
            <br>
            <p>Reckless driving in Virginia carries stiff penalties and they are categorized as criminal offenses.
                Convictions for reckless driving in Virginia can result in the following:</p>
            <ul class="lawyer_list">
            ...
            <span class="align_center_text">
                <h6 class="bold_text">GET HELP FROM AN EXPERIENCED RICHMOND, VA TRAFFIC LAWYER</h6>
    ...
    'testimonial_client_name' => 'Umar',
    'testimonial_content' => '                <p>"I am a highly satisfied client! Because of you, I got a green card. You are efficient and have saved a lot of my time in handling my complicated immigration case.</p>
