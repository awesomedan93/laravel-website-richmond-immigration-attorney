        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::segment(2) == 'seo'?'active ':'' }}treeview">
                ...
                <ul class="treeview-menu">
                    <li class="{{ Request::segment(3) == 'pages.home'?'active ':'' }}"><a href="{{ LaravelLocalization::getLocalizedURL(null, 'dashboard/seo/pages.home') }}"><i class="fa fa-circle-o"></i>Home</a></li>
                    <li class="{{ Request::segment(3) == 'pages.about'?'active ':'' }}"><a href="{{ LaravelLocalization::getLocalizedURL(null, 'dashboard/seo/pages.about') }}"><i class="fa fa-circle-o"></i>About</a></li>
                    <li class="{{ activeMenuCases(Request::segment(3)) }}">
                        <a href="{{ LaravelLocalization::getLocalizedURL(null, 'dashboard/seo/pages.cases') }}"><i class="fa fa-circle-o"></i>Cases We Handle
                            <span class="pull-right-container">
                              <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            ...
                            <li class="{{ Request::segment(3) == 'pages.cases.dui_law'?'active ':'' }}"><a href="{{ LaravelLocalization::getLocalizedURL(null, 'dashboard/seo/pages.cases.dui_law') }}"><i class="fa fa-circle-o"></i>DUI Law</a></li>
                        </ul>
                    </li>
                    <li class="{{ activeMenuAttorneys(Request::segment(3)) }}">
                        <a href="{{ LaravelLocalization::getLocalizedURL(null, 'dashboard/seo/pages.attorneys') }}"><i class="fa fa-circle-o"></i>Attorneys
                            <span class="pull-right-container">
                              <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                    ...
                    <li class="{{ Request::segment(3) == 'pages.reviews'?'active ':'' }}"><a href="{{ LaravelLocalization::getLocalizedURL(null, 'dashboard/seo/pages.reviews') }}"><i class="fa fa-circle-o"></i>Reviews</a></li>
                    <li class="{{ Request::segment(3) == 'pages.blog'?'active ':'' }}"><a href="{{ LaravelLocalization::getLocalizedURL(null, 'dashboard/seo/pages.blog') }}"><i class="fa fa-circle-o"></i>Blog</a></li>
                    <li class="{{ Request::segment(3) == 'pages.contact'?'active ':'' }}"><a href="{{ LaravelLocalization::getLocalizedURL(null, 'dashboard/seo/pages.contact') }}"><i class="fa fa-circle-o"></i>Contact</a></li>
                </ul>
            </li>
