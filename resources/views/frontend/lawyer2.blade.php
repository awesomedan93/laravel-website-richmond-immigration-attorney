        ...
        <div class="container">
            ...
            <div class="lawyer_block">
                <div class="lawyer_left_block">
                    <img src="{{ asset('./img/best-immigration-lawyer-in-chesterfield.webp') }}" alt="best immigration lawyer in chesterfield">
                    <p>
                        Email: raul@novotaghavi.com<br>
                        Phone: (804) 614-6920
                    </p>
                </div>
            ...
            <br>
            <span class="bold_text">Languages:</span> English, Persian, Dari, Spanish<br>
            <span class="bold_text">Memberships</span><br>
